import pygame
from digit_recogniser import *
#The pen colors and other stuffs
...
width = 640
height = 640
#This will initialise the screen and create an 'game-open' window 
screen = pygame.display.set_mode((width*2, height))
screen.fill(white)
pygame.font.init()
##CODE TAKEN FROM PYGAME REPO -"How to create a multi-user drawing game using pygame - john doe "
...
try:
    while True:
        ...
        if e.type == pygame.MOUSEBUTTONUP and e.button != 3:
            ...
            output_img = get_image_output(fname)
